...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //tempTextView.setText("70");

        dateTextView.setText(getCurrentDate());



        String url = "http://api.openweathermap.org/data/2.5/weather?q=Surakarta&APPID=ba903f6b245e1eb562eaa43f61954ac4&units=Imperial";
                ...
                (Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject responseObject) {
                        ...
                        try {
                            ...
                            //int iconResourceId = getResources().getIdentifier("icon" + weatherDescription.replace(" ",""),"drawable",getPackageName());
